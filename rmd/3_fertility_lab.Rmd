...
Let's look at parity progression ratios by birth order, and see if those differ by the sex of the child. The data used here come from the 1990 China Census, which is available on the IPUMS website (https://international.ipums.org). 
